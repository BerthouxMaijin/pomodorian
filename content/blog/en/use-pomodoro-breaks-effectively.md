...
Your work session likely involves focused, directed attention — reading, writing, problem-solving. An effective break should engage a different kind of attention entirely. [Attention Restoration Theory](https://positivepsychology.com/attention-restoration-theory/), developed by psychologist Stephen Kaplan, proposes that environments requiring "soft fascination" — like watching clouds, looking at trees, or listening to water — allow your directed attention to rest and recover.
...
The [American Academy of Ophthalmology](https://www.aao.org/eye-health/diseases/what-is-eye-strain) recommends the 20-20-20 rule for screen workers: every 20 minutes, look at something 20 feet away for at least 20 seconds. Your Pomodoro breaks are a perfect time to give your eyes a real rest.
...
Put on a short ambient track — rain, birds, or a lo-fi loop. Just listen without doing anything else. If you're using [Pomodorian](https://pomodorian.app) for your sessions, the ambient sounds (rain, café noise, fireplace, nature) work well during breaks too — just let them play while you close your eyes.
