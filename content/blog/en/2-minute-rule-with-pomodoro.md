...
The 2-minute rule comes from David Allen's [Getting Things Done (GTD)](https://gettingthingsdone.com/2020/05/the-two-minute-rule-2/) methodology, one of the most influential productivity systems ever published. The rule is simple:
...
There's a well-documented psychological phenomenon behind this: the [Zeigarnik effect](https://www.simplypsychology.org/zeigarnik-effect.html). First described by psychologist Bluma Zeigarnik in 1927, it shows that our brains are wired to keep incomplete tasks active in memory. Unfinished business creates what productivity experts often call "open loops" — persistent background processes that consume cognitive resources.

A [study by Masicampo and Baumeister (2011)](https://pubmed.ncbi.nlm.nih.gov/21688924/) published in the *Journal of Personality and Social Psychology* confirmed this effect and added an important finding: simply making a concrete plan for when and how you'll complete an unfinished task eliminates much of the mental interference. In other words, your brain doesn't need the task to be *done* — it needs to know the task is *handled*.
...
But here's what happens when you ignore these small tasks: they accumulate. And each one becomes a micro-decision you need to make later — when should I do this? Is it still relevant? Where did I put that note? This drains your mental energy through [decision fatigue](https://thedecisionlab.com/biases/decision-fatigue), a phenomenon where the sheer volume of choices degrades your ability to make good ones.

## How the Pomodoro Technique Protects Deep Work

While the 2-minute rule is great for quick tasks, some work demands sustained, uninterrupted attention. That's where the [Pomodoro Technique](https://en.wikipedia.org/wiki/Pomodoro_Technique) comes in.
...
Research on [task switching from the American Psychological Association](https://www.apa.org/topics/research/multitasking) shows why this matters. Even brief mental shifts between tasks carry measurable costs in time and accuracy. The more complex the work, the higher the cost. Pomodoro eliminates this by creating a protected bubble of single-tasking.
...
- **GTD** answers: *What should I work on?* It gives you a system for capturing, organizing, and prioritizing everything on your plate.
- **Pomodoro** answers: *How do I actually do the work?* It gives you a structure for executing with focus and managing your energy.

The [2-minute rule bridges these two systems perfectly](https://facilethings.com/blog/en/pomodoro-technique). It acts as a sorting mechanism: quick tasks get dispatched immediately (GTD's efficiency principle), while bigger tasks get scheduled into focused pomodoro sessions (Pomodoro's deep work principle).
...
- **Can I do this in under two minutes?** Do it now.
- **Does this need focused time?** Add it to your task list for a pomodoro session.
- **Is this not actionable?** Archive it, delegate it, or trash it.
...
This is where a tool like [Pomodorian](https://pomodorian.app) makes the routine frictionless — start the timer, let the ambient sounds keep you in the zone, and handle the small stuff between sessions.
...
- Reply to that message? Two minutes. Done.
- Rename that file? Thirty seconds. Done.
- Approve that PR? One minute. Done.
...
- Process overnight messages and emails using the 2-minute rule
- Move anything requiring focus to your task list
- Pick your top 3 priorities for the day

**Morning focus block (4 pomodoros / ~2 hours)**
- Deep work on your highest-priority task
- Use breaks to handle any quick tasks that pop up
- Track your progress — apps like [Pomodorian](https://pomodorian.app) can help you see patterns over time

**Midday processing (10 min)**
- Quick inbox sweep with the 2-minute rule
- Reassess afternoon priorities if needed

**Afternoon focus block (3-4 pomodoros / ~1.5-2 hours)**
- Tackle your second or third priority
- Continue dispatching quick tasks during breaks

**End-of-day review (10 min)**
- Final 2-minute-rule sweep
