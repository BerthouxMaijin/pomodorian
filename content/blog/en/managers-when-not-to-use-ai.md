---
title: "Managers: When NOT to Use AI (And Why It Matters)"
description: "Strategic decisions, mentoring, meetings: when AI weakens your leadership. A guide for managers who want to stay in control."
date: "2026-04-02"
...
1. [The question nobody is asking](#1-the-question-nobody-is-asking)
2. [5 situations where AI weakens your leadership](#2-5-situations-where-ai-weakens-your-leadership)
3. [The real danger: silent erosion of judgment](#3-the-real-danger-silent-erosion-of-judgment)
4. [Framework: the "AI or not" matrix](#4-framework-the-ai-or-not-matrix)
5. [How to protect your human thinking time](#5-how-to-protect-your-human-thinking-time)
...
A [2026 Deloitte study](https://www.deloitte.com/us/en/insights/topics/talent/human-capital-trends/2026/decision-making-with-ai.html) found that 60% of executives already use AI to support decisions, yet 85% of business leaders regret or question past decisions. Even more striking: 57% of organizations operate at low decision-making maturity. AI speeds up decisions, but not necessarily their quality.
...
[McKinsey identifies three capabilities](https://www.mckinsey.com/capabilities/strategy-and-corporate-finance/our-insights/building-leaders-in-the-age-of-ai) that generative AI cannot replicate: setting aspirations (a machine cannot define an organization's purpose), "reading the room" (anticipating emotional reactions to change), and using empathy to map the right people to the right projects.
...
A [Harvard Business Review study](https://hbr.org/2026/03/the-risks-of-letting-ai-direct-conversations) found that LLMs systematically under-use "subjective questions" -- the ones that explore emotional and political dynamics ("What is not being said?"). In a mentoring context, these are precisely the questions that unlock breakthroughs.
...
More concerning: a [study published in Nature](https://www.nature.com/articles/s41586-025-09505-x) demonstrates that delegating decisions to AI **increases dishonest behavior**. When an algorithmic intermediary absorbs perceived responsibility, humans feel less guilty about taking ethical shortcuts.
...
To learn more about avoiding the cognitive overload that comes with this pressure, read our guide on [preventing burnout as a professional](/blog/avoid-burnout-software-engineer).
...
The guiding principle fits in one sentence, borrowed from [Deloitte](https://www.deloitte.com/us/en/insights/topics/talent/human-capital-trends/2026/decision-making-with-ai.html): **"The real question isn't 'What does the model say?' It's 'Who gets to disagree with it, and how fast?'"**
...
For more on protecting your focus in an interruption-heavy environment, read our guide on [setting boundaries when working from home](/blog/set-boundaries-working-from-home) and how [group Pomodoro sessions](/blog/group-pomodoro-team-sessions) can bring structured focus to your entire team.
...
Yes, with adapted intervals. Managers who use [Pomodorian](https://pomodorian.app) to structure their preparation blocks -- dossier review, feedback writing, strategic planning -- report better ability to focus on one subject at a time instead of bouncing between emails, Slack, and AI tools.
