---
title: "Ultradian Rhythms: Your Body's Natural 90-Minute Focus Cycles"
description: "Discover how ultradian rhythms create natural 90-minute focus cycles and learn to align your work with your body clock for better productivity."
date: "2026-03-27"
...
sources:
  ...
  - "https://academic.oup.com/sleep/article-pdf/5/4/311/13677735/050401.pdf"
  - "https://www.tandfonline.com/doi/abs/10.1080/09291018009359701"
  - "https://www.ernestrossi.com/interviews/ultradia.htm"
...
You are probably familiar with circadian rhythms -- the roughly 24-hour cycle that governs your sleep-wake pattern. Ultradian rhythms are shorter cycles that repeat multiple times within a single day. The most studied of these is the [Basic Rest-Activity Cycle (BRAC)](https://en.wikipedia.org/wiki/Basic_rest%E2%80%93activity_cycle), first proposed by sleep researcher Nathaniel Kleitman in the early 1960s.
...
Kleitman's original hypothesis was expanded significantly by subsequent researchers. [Peretz Lavie](https://www.tandfonline.com/doi/abs/10.1080/09291018009359701) at the Technion Institute in Israel conducted studies measuring reaction time, arithmetic performance, and sustained attention in subjects who were unaware of the 90-minute hypothesis. He documented consistent oscillations in alertness aligning with the BRAC framework, and his pupillometric research showed that [pupillary stability varied rhythmically](https://pubmed.ncbi.nlm.nih.gov/534670/) with periodicities of approximately 75 to 125 minutes.

A study measuring [EEG power spectra, mood, and performance](https://pubmed.ncbi.nlm.nih.gov/7870505/) every 15 minutes over 9 hours in university students found that behavioral and subjective variables fluctuated at a rate consistent with ultradian periodicities.

Psychotherapist Ernest Rossi took the research in a more applied direction. In his book *The 20-Minute Break*, Rossi coined the term [Ultradian Stress Syndrome](https://www.ernestrossi.com/interviews/ultradia.htm) to describe what happens when you chronically override your body's natural rest signals: fatigue, loss of mental focus, increased errors, irritability, and eventually psychosomatic symptoms. His argument was straightforward -- every 90 minutes or so, your body sends signals that it needs a brief recovery period, and ignoring those signals accumulates a physiological toll.

I should note that the science is not perfectly unanimous. Some studies, [including one testing 60 subjects](https://academic.oup.com/sleep/article-pdf/5/4/311/13677735/050401.pdf) every 10 minutes over 9 hours, found no statistically significant 90-minute periodicity using strict criteria. The current consensus is that ultradian cycles during wakefulness are real but may operate through different mechanisms than the REM-NREM cycles of sleep, and individual variation is significant. The 90-minute number is an average, not a universal constant.
...
I noticed this pattern in my own work long before I knew the term "ultradian rhythm." When building [Pomodorian](https://pomodorian.app), I was running long coding sessions and hitting a wall around the 80-minute mark almost every time. I used to push past it. Once I started using that dip as a signal to take a genuine 15-minute break -- walking, stretching, looking at something other than a screen -- I found the next 90-minute block was dramatically more productive.

## How Ultradian Rhythms Connect to Peak Performance

The connection between these biological cycles and high performance shows up in unexpected places. Anders Ericsson's landmark [study of elite violinists](https://psycnet.apa.org/record/1993-40718-001) at the Berlin Music Academy found that the best performers practiced in sessions of no more than 90 minutes, followed by breaks. They also limited their total daily [deliberate practice](https://pmc.ncbi.nlm.nih.gov/articles/PMC6824411/) to roughly 4 hours, split into two or three focused blocks. The top violinists even napped in the afternoon to recover between sessions.
...
The standard 25-minute Pomodoro was designed by Francesco Cirillo as a general-purpose focus tool, and it works well for many tasks. But for deep work that benefits from sustained concentration -- coding, writing, design -- you may find that [longer sessions](/blog/long-pomodoro-sessions-guide) of 50 to 90 minutes align better with your ultradian cycle.

The key is flexibility. Some days I use classic 25-minute intervals for administrative work and email. For deep coding sessions, I switch to 90-minute blocks. Pomodorian lets you [customize your session lengths](/blog/customize-pomodoro-intervals) to match what the task and your body actually need, rather than forcing everything into one rigid format.
...
- Your brain cycles through approximately 90-minute waves of high focus and low focus throughout the day, driven by ultradian rhythms first described by Nathaniel Kleitman.
- Working through the low phase produces inferior results at higher effort. Taking a genuine 15-to-20-minute break during the trough recharges your next focus cycle.
- Elite performers across fields -- from violinists to programmers -- tend to work in sessions that naturally align with the 90-minute cycle, with real rest between blocks.
- The Pomodoro Technique can be adapted to match your ultradian rhythm by using longer session lengths for deep work and shorter intervals for lighter tasks.
- You have roughly three to four high-quality focus blocks per day. Plan your most important work to fill those blocks, and schedule everything else around them.
...
If you want to experiment with aligning your work sessions to your natural focus cycles, [Pomodorian](https://pomodorian.app) lets you set custom timer lengths for exactly this purpose. Try a few days of 90-minute sessions with 20-minute breaks and see how it compares to your current routine. Your body has been telling you when to focus and when to rest all along -- you just need to start listening.
