---
title: "Ritmos Ultradianos: Los Ciclos Naturales de 90 Minutos de Tu Cerebro"
description: "Descubre cómo los ritmos ultradianos crean ciclos naturales de concentración de 90 minutos y aprende a alinear tu trabajo con tu reloj biológico."
date: "2026-04-01"
readTime: "7 min"
keywords:
  - ritmos ultradianos
  - ciclo 90 minutos concentración
  - productividad natural
  - reloj biológico enfoque
status: published
score: 9
sources:
...
Probablemente conozcas los ritmos circadianos: el ciclo de aproximadamente 24 horas que gobierna tu patrón de sueño y vigilia. Los ritmos ultradianos son ciclos más cortos que se repiten varias veces en un solo día. El más estudiado es el [Ciclo Básico de Reposo-Actividad (BRAC)](https://en.wikipedia.org/wiki/Basic_rest%E2%80%93activity_cycle), propuesto por primera vez por el investigador del sueño Nathaniel Kleitman a principios de los años 60.
...
La hipótesis original de Kleitman fue ampliada significativamente por investigadores posteriores. [Peretz Lavie](https://www.tandfonline.com/doi/abs/10.1080/09291018009359701), del Instituto Technion en Israel, realizó estudios midiendo el tiempo de reacción, el rendimiento aritmético y la atención sostenida en sujetos que desconocían la hipótesis de los 90 minutos. Documentó oscilaciones consistentes en la alerta alineadas con el marco BRAC, y su investigación pupilométrica mostró que [la estabilidad pupilar variaba rítmicamente](https://pubmed.ncbi.nlm.nih.gov/534670/) con periodicidades de aproximadamente 75 a 125 minutos.

Un estudio que midió [espectros de potencia EEG, estado de ánimo y rendimiento](https://pubmed.ncbi.nlm.nih.gov/7870505/) cada 15 minutos durante 9 horas en estudiantes universitarios encontró que las variables conductuales y subjetivas fluctuaban a un ritmo consistente con las periodicidades ultradianas.

El psicoterapeuta Ernest Rossi llevó la investigación en una dirección más aplicada. En su libro *The 20-Minute Break*, Rossi acuñó el término [Síndrome de Estrés Ultradiano](https://www.ernestrossi.com/interviews/ultradia.htm) para describir lo que ocurre cuando ignoras crónicamente las señales naturales de descanso de tu cuerpo: fatiga, pérdida de concentración, más errores, irritabilidad y, eventualmente, síntomas psicosomáticos. Su argumento era directo: cada 90 minutos aproximadamente, tu cuerpo envía señales de que necesita un breve periodo de recuperación, e ignorar esas señales acumula un costo fisiológico.

Conviene señalar que la ciencia no es perfectamente unánime. Algunos estudios, [incluyendo uno que evaluó a 60 sujetos](https://academic.oup.com/sleep/article-pdf/5/4/311/13677735/050401.pdf) cada 10 minutos durante 9 horas, no encontraron una periodicidad de 90 minutos estadísticamente significativa usando criterios estrictos. El consenso actual es que los ciclos ultradianos durante la vigilia son reales, pero podrían operar a través de mecanismos diferentes a los ciclos REM-NREM del sueño, y la variación individual es significativa. La cifra de 90 minutos es un promedio, no una constante universal.
...
Yo noté este patrón en mi propio trabajo mucho antes de conocer el término "ritmo ultradiano." Cuando estaba construyendo [Pomodorian](https://pomodorian.app), hacía sesiones largas de programación y chocaba contra un muro alrededor de los 80 minutos, casi cada vez. Solía empujarme a seguir. Cuando empecé a usar esa caída como señal para tomar un descanso genuino de 15 minutos -- caminar, estirar, mirar algo que no fuera una pantalla -- descubrí que el siguiente bloque de 90 minutos era dramáticamente más productivo.

## Cómo se conectan los ritmos ultradianos con el alto rendimiento

La conexión entre estos ciclos biológicos y el alto rendimiento aparece en lugares inesperados. El estudio emblemático de Anders Ericsson sobre [violinistas de élite](https://psycnet.apa.org/record/1993-40718-001) en la Academia de Música de Berlín encontró que los mejores intérpretes practicaban en sesiones de no más de 90 minutos, seguidas de descansos. También limitaban su [práctica deliberada](https://pmc.ncbi.nlm.nih.gov/articles/PMC6824411/) diaria total a aproximadamente 4 horas, divididas en dos o tres bloques concentrados. Los mejores violinistas incluso dormían siesta por la tarde para recuperarse entre sesiones.
...
- Tu cerebro atraviesa ondas de aproximadamente 90 minutos de alta y baja concentración a lo largo del día, impulsadas por los ritmos ultradianos descritos por primera vez por Nathaniel Kleitman.
- Trabajar durante la fase baja produce resultados inferiores con mayor esfuerzo. Tomar un descanso genuino de 15 a 20 minutos durante el valle recarga tu siguiente ciclo de concentración.
- Los profesionales de élite en distintos campos -- desde violinistas hasta programadores -- tienden a trabajar en sesiones que se alinean naturalmente con el ciclo de 90 minutos, con descanso real entre bloques.
- La Técnica Pomodoro se puede adaptar a tu ritmo ultradiano usando sesiones más largas para el trabajo profundo e intervalos más cortos para tareas ligeras.
- Tienes aproximadamente tres o cuatro bloques de concentración de alta calidad al día. Planifica tu trabajo más importante para esos bloques, y programa todo lo demás alrededor.
