---
title: "Le multitâche est un mythe : pourquoi et quoi faire"
description: "Le multitâche est un mythe prouvé par les neurosciences. Découvrez le single-tasking et comment le focus sur une tâche booste votre productivité."
date: "2026-03-25"
readTime: "7 min"
keywords:
  - multitâche mythe
...
Le neuroscientifique Earl Miller, du MIT, résume la situation de manière directe : « Les gens ne savent pas vraiment faire du multitâche, et quand ils disent qu'ils en sont capables, ils se leurrent. Le cerveau excelle dans l'art de se tromper lui-même. » ([NPR, 2008](https://www.npr.org/2008/10/02/95256794/think-youre-multitasking-think-again))
...
D'après les travaux de Joshua Rubinstein, David Meyer et Jeffrey Evans, publiés dans le *Journal of Experimental Psychology*, le task-switching peut coûter jusqu'à [40 % de temps productif](https://www.apa.org/topics/research/multitasking). Plus les tâches sont complexes, plus le coût est élevé.
...
La chercheuse Sophie Leroy (Université de Washington) a identifié un mécanisme particulièrement sournois qu'elle appelle le **résidu attentionnel** (*attention residue*). Quand vous quittez une tâche A pour passer à une tâche B, une partie de votre attention reste « collée » à la tâche A — surtout si celle-ci n'était pas terminée. Ce [résidu cognitif](https://doi.org/10.1016/j.obhdp.2009.04.002) dégrade vos performances sur la tâche B, même si vous n'en avez pas conscience.
...
Gloria Mark, chercheuse à l'Université de Californie à Irvine, a mesuré qu'il faut en moyenne **23 minutes et 15 secondes** pour retrouver un niveau de concentration équivalent après une interruption ([Mark, Gudith & Klocke, 2008](https://ics.uci.edu/~gmark/chi08-mark.pdf)). Presque un quart d'heure de plus que ce que la plupart des gens imaginent.
...
La technique Pomodoro — des sessions de 25 minutes de travail focalisé suivies de 5 minutes de pause — reste l'une des méthodes les plus efficaces pour maintenir le focus sur une tâche. Une analyse de [DeskTime](https://desktime.com/blog/17-52-ratio-most-productive-people) a montré que les personnes les plus productives travaillent en moyenne 52 minutes puis prennent 17 minutes de pause — un rythme qui s'inscrit dans la même logique de sprints focalisés avec des pauses intentionnelles.

Si vous cherchez un outil simple pour structurer ces sessions, [Pomodorian](https://pomodorian.app) combine un timer intelligent avec des sons d'ambiance (pluie, lo-fi, café) conçus pour renforcer la concentration. Le fait d'avoir un cadre temporel défini vous aide à résister à la tentation de « jeter un œil rapide » à vos emails.

**3. Fermez tout ce qui n'est pas la tâche en cours**

C'est radical, mais efficace :

- Fermez les onglets inutiles (oui, les 47 onglets)
- Désactivez les notifications pendant vos blocs de travail
- Mettez votre téléphone en mode « Ne pas déranger » ou dans une autre pièce
- Si vous utilisez Slack, passez en mode « Ne pas déranger » avec un message de statut clair
...
Le concept de [deep work](/deep-work-timer), popularisé par Cal Newport, désigne ces périodes de travail profondément focalisé où vous produisez un travail de haute qualité. C'est l'opposé exact du multitâche : pas d'interruptions, pas de notifications, une seule tâche complexe qui mobilise toute votre attention.
...
- **Mesurez vos résultats, pas votre activité.** La vraie question n'est pas « combien de choses ai-je touchées aujourd'hui ? » mais « qu'est-ce que j'ai terminé ? »
- **Commencez petit.** Un seul bloc Pomodoro de 25 minutes par jour, sans aucune interruption. Constatez la différence de qualité dans ce que vous produisez.
- **Communiquez vos plages de focus à votre équipe.** « Je suis en deep work de 9h à 11h, disponible après. » La plupart des collègues respecteront ça — et certains s'en inspireront.
- **Acceptez l'inconfort.** Les premières sessions monotâche peuvent sembler frustrantes, surtout si vous êtes habitué à l'hyperconnexion. C'est normal. Votre cerveau doit se réhabituer à la concentration soutenue.
...
La productivité monotâche n'est pas un luxe ni une mode. C'est la manière dont notre cerveau fonctionne le mieux. Le single-tasking, combiné à des techniques comme le [Pomodoro](/blog/pomodoro-technique-complete-guide) et le deep work, permet de produire un travail de meilleure qualité en moins de temps, avec moins de fatigue.
