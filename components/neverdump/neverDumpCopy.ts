...
export type NeverDumpMode = "serious" | "fun" | "reset";
...
export const NEVER_DUMP_COPY = {
  en: {
    shared: {
      ...
      minuteShort: "min",
      settingsAutoOpen: "Auto-open Never Dump on long breaks",
  ...
  pt: {
    shared: { skip: "Pular — aproveite a pausa", back: "Voltar", start: "Começar", done: "Concluído", finishEarly: "Terminar agora", breakRemaining: "Pausa restante", privacy: "Somente local. Nada é salvo ou enviado.", answer: "Sua resposta", confidence: "Confiança", reveal: "Revelar", compare: "Comparar resposta", nextRandom: "Outro jogo aleatório", chooseAnother: "Escolher outro", source: "Fonte", invariant: "A regra invariável", openQuestion: "A pergunta em aberto", recall: "Do que você se lembra?", resultTitle: "Piloto automático interrompido.", resultBody: "Sem pontuação cerebral. Você fez algo que a máquina não escolheu.", safeNote: "Pare se sentir desconforto. Caminhe somente em local seguro.", minuteShort: "min", settingsAutoOpen: "Abrir Never Dump automaticamente nas pausas longas", audioUnavailable: "O áudio não pôde iniciar. Você ainda pode fazer três minutos de silêncio." },
    intro: { eyebrow: "Runtime humano", title: "Nunca terceirize seu cérebro.", body: "A IA pode terminar a frase. Não pode terminar o pensamento. Use alguns minutos da pausa para voltar.", run: "Iniciar Never Dump" },
  ...
  ja: {
    shared: { skip: "スキップして休憩する", back: "戻る", start: "開始", done: "完了", finishEarly: "今すぐ終了", breakRemaining: "残り休憩時間", privacy: "端末内のみ。入力内容は保存も送信もされません。", answer: "あなたの回答", confidence: "確信度", reveal: "答えを見る", compare: "回答を比較", nextRandom: "別のランダムゲーム", chooseAnother: "別のものを選ぶ", source: "原文", invariant: "変えてはいけない条件", openQuestion: "未解決の問い", recall: "何を覚えていますか？", resultTitle: "自動操縦を中断しました。", resultBody: "脳の点数はありません。機械が選ばなかった行動を一つ実行しました。", safeNote: "不快に感じたら中止してください。安全な場所でのみ歩いてください。", minuteShort: "分", settingsAutoOpen: "長い休憩で Never Dump を自動的に開く", audioUnavailable: "音声を開始できませんでした。静かな3分間を過ごすことはできます。" },
    intro: { eyebrow: "ヒューマン・ランタイム", title: "脳を手放さない。", body: "AIは文を完成できます。しかし思考まで完成させる必要はありません。休憩の数分で自分に戻りましょう。", run: "Never Dumpを開始" },
...
} satisfies Record<UiLocale, NeverDumpCopy>;
