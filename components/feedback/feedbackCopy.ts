...
export const FEEDBACK_COPY = {
  en: {
    ...
    description:
      "Pomodorian is still being built. Do you have a minute to tell us what helps, what gets in the way, and what is missing?",
  ...
  fr: {
    ...
    description:
      "C’est encore en construction. Tu as une minute pour nous dire ce qui t’aide, ce qui te gêne et ce qui manque ?",
  ...
  es: {
    ...
    description:
      "Pomodorian sigue en construcción. ¿Tienes un minuto para contarnos qué te ayuda, qué te molesta y qué falta?",
  ...
  de: {
    ...
    description:
      "Pomodorian wird noch entwickelt. Hast du eine Minute, um uns zu sagen, was dir hilft, was dich stört und was noch fehlt?",
  ...
  pt: {
    ...
    description:
      "O Pomodorian ainda está em construção. Tem um minuto para nos dizer o que ajuda, o que atrapalha e o que está faltando?",
  ...
  it: {
    ...
    description:
      "Pomodorian è ancora in costruzione. Hai un minuto per dirci cosa ti aiuta, cosa ti ostacola e cosa manca?",
  ...
  ja: {
    ...
    description:
      "Pomodorianはまだ開発中です。役に立つ点、使いにくい点、足りない点を1分で教えていただけますか？",
  ...
  zh: {
    ...
    description:
      "Pomodorian 仍在开发中。可以用 1 分钟告诉我们哪些功能有帮助、哪些地方造成困扰，以及还缺少什么吗？",
    feedbackCta: "发送反馈",
    bugCta: "报告问题",
    dismissCta: "暂时不要",
